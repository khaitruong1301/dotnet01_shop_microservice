...
public partial class ProductDbServiceContext : DbContext
{
    public ProductDbServiceContext()
    {
    }

    public ProductDbServiceContext(DbContextOptions<ProductDbServiceContext> options)
        : base(options)
    {
    }
