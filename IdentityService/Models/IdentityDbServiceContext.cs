...
public partial class IdentityDbServiceContext : DbContext
{
    public IdentityDbServiceContext()
    {
    }

    public IdentityDbServiceContext(DbContextOptions<IdentityDbServiceContext> options)
        : base(options)
    {
    }
