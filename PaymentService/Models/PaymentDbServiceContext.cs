...
public partial class PaymentDbServiceContext : DbContext
{
    public PaymentDbServiceContext()
    {
    }

    public PaymentDbServiceContext(DbContextOptions<PaymentDbServiceContext> options)
        : base(options)
    {
    }
