...
public partial class OrderDbServiceContext : DbContext
{
    public OrderDbServiceContext()
    {
    }

    public OrderDbServiceContext(DbContextOptions<OrderDbServiceContext> options)
        : base(options)
    {
    }
